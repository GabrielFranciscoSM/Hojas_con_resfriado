...
\begin{abstract}
   ...
   Los resultados muestran que incorporar la identificación previa del huésped incrementa la precisión media (mAP) en un 11\% respecto a los detectores genéricos de una sola etapa ("end-to-end"), demostrando la superioridad de los modelos condicionados biológicamente.
\end{abstract}
...
De igual forma, en las rosas, aunque la detección ya era buena, el modelo especializado mejoró drásticamente la calidad del ajuste de las cajas (\textit{bounding boxes}), subiendo el mAP50-95 de 0.54 a casi 0.65. Esto confirma que, para obtener un rendimiento de excelencia (con un promedio global de 0.9170), es necesario que la red neuronal se centre exclusivamente en un solo cultivo, captando matices que un modelo generalista pasa por alto.
...
>>>>>>> 4fd1f32 (docs: inclusión de repositorio)
